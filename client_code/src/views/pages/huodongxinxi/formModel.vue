	...
	<div class="detail-page" :style='{}'>
		...
		<div class="detail_view">
			...
			<div class="info_view">
				...
				<div class="btn_view">
					<el-button class="cross_btn" v-if="btnFrontAuth(tableName,'报名')" @click="huodongbaomingonAcross('报名','huodongbaoming','','','','')" type="warning">报名</el-button>
...
<script setup>
	...
	const huodongbaomingonAcross = async (btnType,table,crossOptAudit,crossOptPay,statusColumnName,tips,statusColumnValue,type=1) => {

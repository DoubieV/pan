			...
			<el-row>
				...
				<el-col :span="24">
					<el-form-item label="入住详情" prop="ruzhuxiangqing">
						<editor class="list_editor" :value="form.ruzhuxiangqing" placeholder="请输入入住详情" :readonly="!isAdd||disabledForm.ruzhuxiangqing?true:false"
							@change="(e)=>editorChange(e,'ruzhuxiangqing')"></editor>
					</el-form-item>
				</el-col>
			</el-row>
...
<script setup>
	...
	const getInfo = ()=>{
		context?.$http({
			...
			res.data.data.ruzhuxiangqing = res.data.data.ruzhuxiangqing.replace(reg,'../../../cl75385428/file');

...
.forget_view .list_btn .get_btn{ width: 100%; height: 46px; line-height: 46px; background: #2f3f56; border: 0px solid #ccc; font-weight: 500; font-size: 18px; color: #fff; margin-bottom:20px; padding:0; border-radius:0px; } 
.forget_view .list_btn .get_btn:hover {  } 

.forget_view .list_btn .valid_btn{  width: 100%; height: 46px; line-height: 46px; background: #2f3f56; border: 0px solid #ccc; font-weight: 500; font-size: 18px; color: #fff; margin-bottom:20px; padding:0; border-radius:0px; } 
.forget_view .list_btn .valid_btn:hover {  } 

.forget_view .list_btn .update_btn{  width: 100%; height: 46px; line-height: 46px; background: #2f3f56; border: 0px solid #ccc; font-weight: 500; font-size: 18px; color: #fff; margin-bottom:20px; padding:0; border-radius:0px; } 

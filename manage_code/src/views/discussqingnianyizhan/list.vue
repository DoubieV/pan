	...
	<div>
		<div class="center_view">
			...
			<div class="list_search_view">
				...
				<div class="btn_view">
					<el-button class="add_btn" type="success" @click="addClick" v-if="btnAuth('discussqingnianyizhan','新增')">
			...
			<el-table
                ...
                <el-table-column v-if="btnAuth('discussqingnianyizhan','修改')" label="禁用账号" :resizable='true' :sortable='false' align="left" header-align="left">
                    <template #default="scope">
				...
				<el-table-column label="操作" width="300" :resizable='true' :sortable='true' align="left" header-align="left">
					<template #default="scope">
						<el-button class="edit_btn" type="primary" @click="editClick(scope.row.id)" v-if=" btnAuth('discussqingnianyizhan','修改')">
							<i class="iconfont icon-xiugai4"></i>
							修改						</el-button>
						<el-button class="del_btn" type="danger" @click="delClick(scope.row.id)" >
							<i class="iconfont icon-shanchu1"></i>
							删除						</el-button>
						<el-button class="operate_btn" v-if="btnAuth('discussqingnianyizhan','查看评论')" type="warning" @click="commentClick(scope.row.id)">
...
<script setup>
	...
	const tableName = 'discussqingnianyizhan'
	const formName = '青年驿站评论表'
	...
	const commentClick=(id)=>{
		context?.$router.push('/discussdiscussqingnianyizhan?refid=' + id)
	}

...
<script setup>
	...
	const init=(formId=null,formType='add',formNames='',row=null,table=null,statusColumnName=null,tips=null,statusColumnValue=null)=>{
		...
		context?.$http({
			...
			if(json.hasOwnProperty('huodongmingcheng')&& context?.$toolUtil.storageGet("role")!="管理员"){
				form.value.huodongmingcheng = json.huodongmingcheng
				disabledForm.value.huodongmingcheng = true;
			}
			if(json.hasOwnProperty('huodongtupian')&& context?.$toolUtil.storageGet("role")!="管理员"){
				form.value.huodongtupian = json.huodongtupian
				disabledForm.value.huodongtupian = true;
			}
			if(json.hasOwnProperty('huodongdidian')&& context?.$toolUtil.storageGet("role")!="管理员"){
				form.value.huodongdidian = json.huodongdidian
				disabledForm.value.huodongdidian = true;
			}
			if(json.hasOwnProperty('huodongshijian')&& context?.$toolUtil.storageGet("role")!="管理员"){
				form.value.huodongshijian = json.huodongshijian
				disabledForm.value.huodongshijian = true;
			}
			if(json.hasOwnProperty('huodongxiangqing')&& context?.$toolUtil.storageGet("role")!="管理员"){
